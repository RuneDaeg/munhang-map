  ...
  properties: {
    questions: {
      ...
      items: {
        ...
        properties: {
          number: { type: 'integer' },
          latexText: { type: 'string', description: 'Complete question in plain Korean prose; only actual formulas use $...$ LaTeX. No prose text wrappers. Data tables use plain rows.' },
